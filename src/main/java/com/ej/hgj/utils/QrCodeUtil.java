...
//        }
//    }
    public static BufferedImage createCodeToOutputStream(String content, OutputStream outputStream) {
        try {
            if (StringUtils.isBlank(content)) {
                return null;
            }
    ...
    public static void main(String[] args) {
        //使用自定义工具包生成二维码
        File myUtilFileDir = new File("D:\\var\\qrcode");
        QrCodeUtil.createCodeToFile("https://www.bejson.com/",myUtilFileDir,"qrcode.png");
    }
}
