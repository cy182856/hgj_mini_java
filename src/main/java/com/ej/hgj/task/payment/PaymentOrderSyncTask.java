...
@Configuration
@EnableScheduling
public class PaymentOrderSyncTask implements SchedulingConfigurer {
    ...
    /**
     * 智慧管家支付成功订单与思源订单状态同步定时任务
     */
    @Override
    public void configureTasks(ScheduledTaskRegistrar scheduledTaskRegistrar) {
        scheduledTaskRegistrar.addTriggerTask(() -> paymentTaskService.PaymentOrderSync_2(), triggerContext -> {
            Cron cronByType = cronDaoMapper.getByType("7");
