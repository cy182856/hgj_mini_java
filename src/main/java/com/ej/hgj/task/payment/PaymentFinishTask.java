...
@Configuration
@EnableScheduling
public class PaymentFinishTask implements SchedulingConfigurer {
    ...
    public void configureTasks(ScheduledTaskRegistrar scheduledTaskRegistrar) {
        scheduledTaskRegistrar.addTriggerTask(() -> paymentTaskService.updatePaymentStatus_1(), triggerContext -> {
            Cron cronByType = cronDaoMapper.getByType("5");
